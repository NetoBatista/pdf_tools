...
[TestClass]
public class TranscriptRequestDtoTest
{
    ...
    {
        var request = new TranscriptRequestDto
        {
            Type = PdfTypeConstant.Base64,
            File = ExamplePdf
        };
    ...
    [TestMethod("Should be create a valid request url")]
    public void CreateValidUrl()
    {
        var request = new TranscriptRequestDto
        {
            Type = PdfTypeConstant.Url,
            File = ExampleUrl
        };
    ...
    [TestMethod("Should not be create a valid request")]
    public void CreateError()
    {
        ...
        Assert.ThrowsException<PdfToTextRequestException>(() => request.Validate());
    }

    [TestMethod("Should not be create empty file")]
    public void CreateErrorEmptyFile()
    {
        var request = new TranscriptRequestDto
        {
            Type = PdfTypeConstant.Base64,
    ...
    [TestMethod("Should not be create a valid request - Empty type")]
    public void CreateErrorEmptyType()
    {
        var request = new TranscriptRequestDto
        {
            Type = string.Empty,
    ...
    [TestMethod("Should not be create a valid request - Incorrect type")]
    public void CreateErrorIncorrectType()
    {
        var request = new TranscriptRequestDto
        {
    ...
    [TestMethod("Should not be create a valid request - Incorrect Url")]
    public void CreateErrorIncorrectUrl()
    {
        var request = new TranscriptRequestDto
        {
            Type = PdfTypeConstant.Url,
